...
class Piece:
    ...
    # calculate x & y position base on row and column we are in
    def calc_pos(self):
    ...
    def move(self, row, col):
        self.row = row
        self.col = col
        self.calc_pos()  # tells you the position on where you should be
